...
<form class="popover-form" method="post" action="<?= $this->url->href('Project/ProjectRoleController', 'update', ['project_id' => $project['id'], 'role_id' => $role['role_id']]) ?>" autocomplete="off">
    <?= $this->form->csrf() ?>
