<div class="page-header">
    <h2><?= t('Remove a drag and drop restriction') ?></h2>
</div>
...
<form action="<?= $this->url->href('Project/Column/ColumnMoveRestrictionController', 'remove', ['project_id' => $project['id'], 'restriction_id' => $restriction['restriction_id']]) ?>" method="post" autocomplete="off">
    ...
    <div class="confirm">
        <p class="alert alert-info">
            <?= t('Do you really want to remove this drag and drop restriction: "%s" to "%s"?', $restriction['src_column_title'], $restriction['dst_column_title']) ?>
        </p>
