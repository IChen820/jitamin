...
<form class="popover-form" method="post" action="<?= $this->url->href('Task/Subtask/SubtaskController', 'update', ['task_id' => $task['id'], 'project_id' => $task['project_id'], 'subtask_id' => $subtask['id']]) ?>" autocomplete="off">
