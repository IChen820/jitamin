...
Jitamin.Gantt.prototype.execute = function() {
...
Jitamin.Gantt.prototype.saveRecord = function(record) {
...
Jitamin.Gantt.prototype.show = function() {
...
Jitamin.Gantt.prototype.renderVerticalHeader = function() {
    ...
    for (var i = 0; i < this.data.length; i++) {
        ...
        if (this.data[i].type == "task") {
            ...
            content
                .append(jQuery("<a>", {"href": this.data[i].board_link, "title": $(this.options.container).data("label-board-link")}).append('<i class="fa fa-columns"></i>'))
                .append("&nbsp;")
...
Jitamin.Gantt.prototype.renderSlider = function(startDate, endDate) {
...
Jitamin.Gantt.prototype.renderHorizontalHeader = function(dates) {
...
// Render grid
Jitamin.Gantt.prototype.renderGrid = function(dates) {
...
Jitamin.Gantt.prototype.addBlockContainers = function() {
...
// Render bars
Jitamin.Gantt.prototype.addBlocks = function(slider, start) {
...
Jitamin.Gantt.prototype.getVerticalHeaderTooltip = function(record) {
    var tooltip = "";
...
Jitamin.Gantt.prototype.getBarTooltip = function(record) {
    var tooltip = "";
...
// Set bar color
Jitamin.Gantt.prototype.setBarColor = function(block, record) {
    if (record.not_defined) {
...
Jitamin.Gantt.prototype.listenForBlockResize = function(startDate) {
    var self = this;
...
Jitamin.Gantt.prototype.listenForBlockMove = function(startDate) {
    var self = this;
...
Jitamin.Gantt.prototype.updateDataAndPosition = function(block, startDate) {
...
Jitamin.Gantt.prototype.getDates = function(start, end) {
    var dates = [];
...
Jitamin.Gantt.prototype.prepareData = function(data) {
...
Jitamin.Gantt.prototype.getDateRange = function(minDays) {
...
Jitamin.Gantt.prototype.daysBetween = function(start, end) {
    if (! start || ! end) {
        return 0;
    }
...
Jitamin.Gantt.prototype.isWeekend = function(date) {
    return date.getDay() % 6 == 0;
};

// Clone Date object
Jitamin.Gantt.prototype.cloneDate = function(date) {
    return new Date(date.getTime());
};

// Add days to a Date object
Jitamin.Gantt.prototype.addDays = function(date, value) {
 ...
 */
Jitamin.Gantt.prototype.compareDate = function(date1, date2) {
