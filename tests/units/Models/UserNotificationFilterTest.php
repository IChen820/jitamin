...
class UserNotificationFilterTest extends Base
{
    ...
    public function testFilterNone()
    {
        ...
        $this->assertEquals(2, $u->create(['username' => 'user1', 'email' => 'user1@user1', 'notifications_filter' => UserNotificationFilterModel::FILTER_NONE]));
        $this->assertTrue($n->filterNone($u->getById(2)));

        $this->assertEquals(3, $u->create(['username' => 'user2', 'email' => 'user2@user2', 'notifications_filter' => UserNotificationFilterModel::FILTER_BOTH]));
    ...
    public function testFilterCreator()
    {
        ...
        $this->assertEquals(2, $u->create(['username' => 'user1', 'email' => 'user1@user1', 'notifications_filter' => UserNotificationFilterModel::FILTER_CREATOR]));
        $this->assertTrue($n->filterCreator($u->getById(2), ['task' => ['creator_id' => 2]]));

        $this->assertEquals(3, $u->create(['username' => 'user2', 'email' => 'user2@user2', 'notifications_filter' => UserNotificationFilterModel::FILTER_CREATOR]));
        $this->assertFalse($n->filterCreator($u->getById(3), ['task' => ['creator_id' => 1]]));

        $this->assertEquals(4, $u->create(['username' => 'user3', 'email' => 'user3@user3', 'notifications_filter' => UserNotificationFilterModel::FILTER_NONE]));
    ...
    public function testFilterAssignee()
    {
        ...
        $this->assertEquals(2, $u->create(['username' => 'user1', 'email' => 'user1@user1', 'notifications_filter' => UserNotificationFilterModel::FILTER_ASSIGNEE]));
        $this->assertTrue($n->filterAssignee($u->getById(2), ['task' => ['owner_id' => 2]]));

        $this->assertEquals(3, $u->create(['username' => 'user2', 'email' => 'user2@user2', 'notifications_filter' => UserNotificationFilterModel::FILTER_ASSIGNEE]));
    ...
    public function testFilterBoth()
    {
        ...
        $this->assertEquals(2, $u->create(['username' => 'user1', 'email' => 'user1@user1', 'notifications_filter' => UserNotificationFilterModel::FILTER_BOTH]));
    ...
    public function testFilterProject()
    {
        ...
        $this->assertEquals(2, $u->create(['username' => 'user2', 'email' => 'user2@user2', 'notifications_filter' => UserNotificationFilterModel::FILTER_NONE]));
    ...
    public function testFilterUserWithAssigneeFilter()
    {
        ...
        $this->assertEquals(2, $u->create(['username' => 'user2', 'email' => 'user2@user2', 'notifications_filter' => UserNotificationFilterModel::FILTER_ASSIGNEE]));
    ...
    public function testFilterUserWithCreatorFilter()
    {
        ...
        $this->assertEquals(2, $u->create(['username' => 'user2', 'email' => 'user2@user2', 'notifications_filter' => UserNotificationFilterModel::FILTER_CREATOR]));
    ...
    public function testFilterUserWithBothFilter()
    {
        ...
        $this->assertEquals(2, $u->create(['username' => 'user2', 'email' => 'user2@user2', 'notifications_filter' => UserNotificationFilterModel::FILTER_BOTH]));
    ...
    public function testFilterUserWithBothFilterAndProjectSelected()
    {
        ...
        $this->assertEquals(2, $u->create(['username' => 'user2', 'email' => 'user@user2', 'notifications_filter' => UserNotificationFilterModel::FILTER_BOTH]));
